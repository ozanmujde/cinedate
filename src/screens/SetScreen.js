...
const SetScreen = ({ route: { params } }) => {
  ...
  function handleSubmit() {
    ...
    if (Number(quota) <= 10) {
      axios
        .post("https://wlobby-backend.herokuapp.com/create/advert/", {
          ...
          >
            ...
            <SafeAreaView style={styles.switchContainer}>
              <SafeAreaView style={styles.menSwitch}>
                <Switch
                  disabled={!womenSwitch}
                  value={menSwitch}
                  onValueChange={onToggleMenSwitch}
                  color={"#6200ed"}
                />
                <Headline style={{ fontSize: 20, paddingLeft: 10 }}>
                  Men Can Appeal
                </Headline>
              </SafeAreaView>
              <SafeAreaView style={styles.womenSwitch}>
                <Switch
                  disabled={!menSwitch}
                  value={womenSwitch}
                  onValueChange={onToggleWomenSwitch}
                  color={"#6200ed"}
                />
                <Headline style={{ fontSize: 20, paddingLeft: 10 }}>
                  Women Can Appeal
